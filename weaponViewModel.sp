...
public OnMapStart()
{
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.dx80.vtx");
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.dx90.vtx");
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.mdl");
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.sw.vtx");
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.vvd");
    AddFileToDownloadsTable("models/weapons/fists/v_knife_t.xbox.vtx");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.dx80.vtx");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.dx90.vtx");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.mdl");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.phy");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.sw.vtx");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.vvd");
    AddFileToDownloadsTable("models/weapons/fists/w_knife_t.xbox.vtx");
    AddFileToDownloadsTable("materials/models/weapons/v_models/brass_knuckles/main.vmt");
    AddFileToDownloadsTable("materials/models/weapons/v_models/brass_knuckles/main.vtf");
    AddFileToDownloadsTable("materials/models/weapons/v_models/brass_knuckles/map.vtfd");
    AddFileToDownloadsTable("materials/models/weapons/w_models/brass_knuckles/main.vmt");   
    
    CustomModel1 = PrecacheModel("models/weapons/fists/v_knife_t.mdl");
